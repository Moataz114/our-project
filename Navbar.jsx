    ...
    <header className="text-gray-600 body-font">
      <div className="container mx-auto flex md:flex-nowrap flex-wrap px-5 flex-col lg:flex-row items-center">
        ...
        <div className="flex lg:justify-end justify-center w-full lg:w-1/5">
          <RouterLink to="/auth">
            <button className="inline-flex items-center bg-[#91C2D1] border-0 py-1 px-3 focus:outline-none hover:bg-[#68A8C2] rounded text-lg font-bold mt-4 lg:mt-0">
              {"Sign Out"} {/* Display button text based on login state */}
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
